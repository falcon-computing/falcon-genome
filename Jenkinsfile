...
//                    git branch: 'release', url: 'git@github.com:falcon-computing/falcon-genome.git'
                    ...
                    dir("release"){
                        ...
                        sh "echo $version"
                        sh "module load sdx/17.4; cmake -DCMAKE_BUILD_TYPE=Release -DRELEASE_VERSION=$version-aws -DDEPLOYMENT_DST=aws -DCMAKE_INSTALL_PREFIX=/curr/limark/falcon2/bin .."
//                        sh "make -j 8"
//                        sh "make install"
