...
int germline_main(int argc, char** argv, boost::program_options::options_description &opt_desc)
{
  ...
  opt_desc.add_options()
    ...
    ("generate-bam", po::value<std::string>()->implicit_value(""), "output sorted BAM file generated by aligner")
    ...
    ("output", po::value<std::string>()->required(), "output GVCF/VCF file")
  ...
  std::string output_bam_path = get_argument<std::string>(cmd_vm, "generate-bam");
  ...
  std::string output_vcf_path = get_argument<std::string>(cmd_vm, "output");
