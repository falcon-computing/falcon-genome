...
-bqsr <calibrate.rpt> -o <output_dir> "
  echo " The <input.bam> argument is the markduped bam file"
  echo " The <calibrate.rpt> argument is the report file generated by bqsr stage"
...
if [ ! -z $force_flag ];then
   ...
   check_output_force $chr_recal_bam
  else
