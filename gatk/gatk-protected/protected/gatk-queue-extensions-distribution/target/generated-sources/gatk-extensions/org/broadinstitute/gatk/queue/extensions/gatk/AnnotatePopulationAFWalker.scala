...
@Input(fullName="population", shortName="pop", doc="the VCF containing large populations of samples", required=true, exclusiveOf="", validation="")
...
@Input(fullName="populationIndex", shortName="", doc="Dependencies on the index of population", required=false, exclusiveOf="", validation="")
