...
class AnalyzeCovariates extends org.broadinstitute.gatk.queue.extensions.gatk.CommandLineGATK with ScatterGatherableFunction {
...
override def commandLine = super.commandLine + optional("-before", beforeReportFile, spaceSeparated=true, escape=true, format="%s") + optional("-after", afterReportFile, spaceSeparated=true, escape=true, format="%s") + conditional(ignoreLastModificationTimes, "-ignoreLMT", escape=true, format="%s") + optional("-plots", plotsReportFile, spaceSeparated=true, escape=true, format="%s") + optional("-csv", intermediateCsvFile, spaceSeparated=true, escape=true, format="%s") + conditional(filter_reads_with_N_cigar, "-filterRNC", escape=true, format="%s") + conditional(filter_mismatching_base_and_quals, "-filterMBQ", escape=true, format="%s") + conditional(filter_bases_not_stored, "-filterNoBases", escape=true, format="%s")
}
