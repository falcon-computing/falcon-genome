...
@Argument(fullName="MendelianViolationsFile", shortName="mvf", doc="File to output the mendelian violation details.", required=false, exclusiveOf="", validation="")
...
@Argument(fullName="DeNovoPrior", shortName="prior", doc="Prior for de novo mutations. Default: 1e-8", required=false, exclusiveOf="", validation="")
...
@Argument(fullName="FatherAlleleFirst", shortName="fatherAlleleFirst", doc="Ouputs the father allele as the first allele in phased child genotype. i.e. father|mother rather than mother|father.", required=false, exclusiveOf="", validation="")
