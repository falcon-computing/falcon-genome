...
class HaplotypeCaller extends org.broadinstitute.gatk.queue.extensions.gatk.CommandLineGATK with ScatterGatherableFunction {
...
var likelihoodCalculationEngine: org.broadinstitute.gatk.tools.walkers.haplotypecaller.ReadLikelihoodCalculationEngine.Implementation = _
 ...
 */
def likelihoodEngine_=(value: org.broadinstitute.gatk.tools.walkers.haplotypecaller.ReadLikelihoodCalculationEngine.Implementation) { this.likelihoodCalculationEngine = value }
...
var heterogeneousKmerSizeResolution: org.broadinstitute.gatk.tools.walkers.haplotypecaller.HeterogeneousKmerSizeResolution = _
 ...
 */
def hksr_=(value: org.broadinstitute.gatk.tools.walkers.haplotypecaller.HeterogeneousKmerSizeResolution) { this.heterogeneousKmerSizeResolution = value }
...
var pcr_indel_model: org.broadinstitute.gatk.tools.walkers.haplotypecaller.PairHMMLikelihoodCalculationEngine.PCR_ERROR_MODEL = _
 ...
 */
def pcrModel_=(value: org.broadinstitute.gatk.tools.walkers.haplotypecaller.PairHMMLikelihoodCalculationEngine.PCR_ERROR_MODEL) { this.pcr_indel_model = value }
